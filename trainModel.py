...
"""
# Classe permettant d'entrainer un modele sur une jeu de données
"""
...
#    np.load("finaldf_p_85_12.npy",allow_pickle=True)
    X = data = np.load(pathData + '/' + labels[0] + '.npy', allow_pickle=True)
...
def main():
    ...
    check = ModelCheckpoint('./trainedModel/moModel.hdf5', monitor='val_loss', verbose=0,
